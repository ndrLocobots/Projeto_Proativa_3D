...
public class Cubo : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(320, 65, 200, 200), atrito.staticFriction.ToString("0.00"));
        GUI.Label(new Rect(130, 65, 200, 200), atrito.dynamicFriction.ToString("0.00"));
        ...
        */
        ...
        fad.text = "Força de atrito dinamico: " + forcaAtritoDin.ToString("0.00");
        fae.text = "Força de atrito Estático: " + forcaAtritoEst.ToString("0.00");
